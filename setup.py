...
setupkwargs = dict(
  ...
  entry_points = {
    "console_scripts": [
      ...
      "mergeannotationxmlscohort=astropath.slides.annowarp.mergeannotationxmls:cohortmain",
      "mergeannotationxmlssample=astropath.slides.annowarp.mergeannotationxmls:samplemain",
