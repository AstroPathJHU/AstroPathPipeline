...
setupkwargs = dict(
  ...
  entry_points = {
    "console_scripts": [
      ...
      "mergeannotationxmlscohort=astropath.slides.annowarp.mergeannotationxmls:mergeannotationxmlscohort",
      "mergeannotationxmlssample=astropath.slides.annowarp.mergeannotationxmls:mergeannotationxmlssample",
