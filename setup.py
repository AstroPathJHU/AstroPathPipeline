...
setupkwargs = dict(
  ...
  entry_points = {
    "console_scripts": [
      ...
      "slidesinputcheck=astropath.slides.inputcheck.inputcheck:runsample",
      "slidesinputcheckcohort=astropath.slides.inputcheck.inputcheck:runcohort",
      ...
      "zoomcohortihc=astropath.slides.zoom.zoomcohort:ihc",
      "zoomsample=astropath.slides.zoom.zoomsample:main",
      "zoomsampleihc=astropath.slides.zoom.zoomsample:ihc",
