...
setupkwargs = dict(
  ...
  entry_points = {
    "console_scripts": [
      ...
      "imagecorrectionsample=astropath.hpfs.image_correction.image_correction_sample:main",
      "imagecorrectioncohort=astropath.hpfs.image_correction.image_correction_cohort:main",
