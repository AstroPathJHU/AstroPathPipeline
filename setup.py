...
setupkwargs = dict(
  ...
  entry_points = {
    "console_scripts": [
      ...
      "imagecorrectionsample=astropath.hpfs.image_correction.imagecorrectionsample:main",
      "imagecorrectioncohort=astropath.hpfs.image_correction.imagecorrectioncohort:main",
