...
%% Another figure of perhaps one overexposed and one properly exposed Polaris HPF, from a slide where the median was much lower than the max?
...
%% [image showing an example overlap raw, and then smoothed/corrected/sliced, probably the individual images and then also the overlay]
...
%% [A little bit about the bounds of the fitting and the cost parameterization]
