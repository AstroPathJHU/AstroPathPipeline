...
\begin{table}[ht]
	...
	\multirowcell{3}[0pt][l]{Average shift/field \\ (pixels)} & $x$ & $-1$ & $14$ \\\cline{2-4}
	& $y$ & $-1$ & $10$ \\\cline{2-4}
	& $x$ for new row & $0$ & $-5$ \\\hline
	\multirowcell{4}[0pt][l]{Sine wave amplitude\\(pixels)} & $x$--$\delta x$, $x$ overlap & $1.5$ & $0.7$ \\\cline{2-4}
	& $x$--$\delta y$, $x$ overlap & $0.4$ & $0$ \\\cline{2-4}
	& $y$--$\delta x$, $y$ overlap & $0.5$ & $0$ \\\cline{2-4}
	& $y$--$\delta y$, $y$ overlap & $2.8$ & [other periodic effects] \\\hline
