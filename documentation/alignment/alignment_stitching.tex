...
\begin{table}[ht]
	...
	\hline
	\multicolumn{2}{|l|}{Model} & Vectra 3.0 & Vectra Polaris & Vectra Polaris & Vectra Polaris \\\hline
	\multicolumn{2}{|l|}{Location} & JHU & JHU & BMS & Akoya \\\hline
	\multirowcell{3}[0pt][l]{Average shift/field \\ (pixels)}
	& $\delta x$, $x$ movement & $-0.9$ & & $-0.7$ & $0.7$ \\\cline{2-6}
	& $\delta y$, $x$ movement & $0.1$ & & $0.5$ & $0.0$ \\\cline{2-6}
	& $\delta x$, $y$ movement & $0.1$ & & $-0.4$ & $-0.5$ \\\cline{2-6}
	& $\delta y$, $y$ movement & $-1.1$ & & $-0.3$ & $0.0$ \\\hline
