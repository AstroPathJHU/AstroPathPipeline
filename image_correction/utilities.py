...
def getWarpFieldPathsFromWarpDef(w_def) :
    ...
    dx_warp_field_path = os.path.join(w_def,f'{WARP_CONST.X_WARP_BIN_FILENAME}_{wf_dirname}.bin')
    dy_warp_field_path = os.path.join(w_def,f'{WARP_CONST.Y_WARP_BIN_FILENAME}_{wf_dirname}.bin')
