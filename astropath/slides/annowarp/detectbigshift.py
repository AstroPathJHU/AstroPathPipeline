...
from ...shared.sample import ReadRectanglesDbloadIm3, ReadRectanglesIm3SingleLayer, TissueSampleBase
from ...utilities import units
from ...utilities.miscmath import floattoint
from ..align.computeshift import computeshift
from .annowarpsample import QPTiffSample

class DetectBigShiftSample(ReadRectanglesDbloadIm3, ReadRectanglesIm3SingleLayer, QPTiffSample, TissueSampleBase, scale="zoomedscale"):
