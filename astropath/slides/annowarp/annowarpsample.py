...
from ...shared.sample import MaskWorkflowSampleBase, SampleBase, TissueSampleBase, WorkflowSample, XMLPolygonAnnotationReaderSampleWithOutline, ZoomFolderSampleBase, ZoomFolderSampleComponentTiff
...
class AnnoWarpSampleBase(QPTiffSample, WSISample, ZoomFolderSampleComponentTiff, WorkflowSample, TissueSampleBase, XMLPolygonAnnotationReaderSampleWithOutline, ReadAffineShiftSample, AnnoWarpArgumentParserBase):
  r"""
