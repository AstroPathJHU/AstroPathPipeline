...
class AnnoWarpCohortBase(AnnotationInfoWriterCohort, SelectRectanglesCohort, WorkflowCohort, XMLPolygonReaderCohort, ZoomFolderCohort, AnnoWarpArgumentParserBase):
  """
