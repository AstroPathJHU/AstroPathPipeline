...
from ...shared.sample import DeepCellSegmentationSample, DeepCellSegmentationSampleBase, GeomSampleBase, MesmerSegmentationSample, ParallelSample, ReadRectanglesDbload, ReadRectanglesDbloadSegmentedComponentTiffMultiLayer, SampleWithSegmentations, TissueSampleBase, WorkflowSample
...
class GeomCellSampleInform(GeomCellSampleBase, ReadRectanglesDbloadSegmentedComponentTiffMultiLayer):
