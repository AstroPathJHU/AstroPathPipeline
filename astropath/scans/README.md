...
## 4.2. Contents
 ...
 - [4.4. Scanning Instructions Introduction](docs/ScanningInstructionsIntro.md)
   ...
   - [4.4.5. Whole Slide Scanning Introduction](docs/scanning/WholeSlideScanning.md)
     ...
     - [4.4.5.4. Scan the Whole Slide Specimens (Vectra 3.0)](docs/scanning/ScantheWholeSlideSpecimensVectra3.md)
     - [4.4.5.5. Scan the Whole Slide Specimens (Vectra Polaris)](docs/scanning/ScantheWholeSlideSpecimensVectraPolaris.md)
     - [4.4.5.6. Creating a Whole Slide Scanning Plan](docs/scanning/CreatingaWholeSlideScanningPlan.md)
     - [4.4.5.7. Important Scanning Notes](docs/scanning/ImportantScanningNotes.md)
