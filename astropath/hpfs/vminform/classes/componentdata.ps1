...
--------------------------------------------------------
#>
Class vmcomponentinform : moduletools {
    #
    [string]$abx
    [string]$alg
    [string]$abpath
    ...
    [void]CheckExportLineOption($procedure){
        ...
        #
        if ($exportline -ne $this.export_type_setting.Component) {
            $this.sample.info("Replacing exportline:" + $exportline + "with changedline:" + $this.export_type_setting.Component)
    ...
    [void]CheckErrorDictionary($errorline, $imageid){
        ...
        switch -regex ($errorline) {
            ...
            default {
                ...
                throw 'New inform error: ' + $errorline
            }
        }
        #
    }
