...
- [5.10. VMinForm](vminform#510-vminform"Title")
  ...
  - [5.10.3. inForm® Multipass Phenotyping](vminform/docs/inFormMultipassPhenotype.md#5103-inform-multipass-phenotype "Title")
    - [5.10.3.1. Description](vminform/docs/inFormMultipassPhenotype.md#51031-description "Title")
    - [5.10.3.2. Instructions](vminform/docs/inFormMultipassPhenotype.md#51032-instructions "Title")
      - [5.10.3.2.1. Getting Started](vminform/docs/inFormMultipassPhenotype.md#510321-getting-started "Title")
      - [5.10.3.2.2. Core Icons to Remember](vminform/docs/inFormMultipassPhenotype.md#510322-core-icons-to-remember "Title")
      - [5.10.3.2.3. Segment Tissue](vminform/docs/inFormMultipassPhenotype.md#510323-segment-tissue "Title")
      - [5.10.3.2.4. Adaptive Cell Segmentation](vminform/docs/inFormMultipassPhenotype.md#510324-adaptive-cell-segmentation "Title")
      - [5.10.3.2.5. Phenotyping](vminform/docs/inFormMultipassPhenotype.md#510325-phenotyping "Title")
      - [5.10.3.2.6. Export](vminform/docs/inFormMultipassPhenotype.md#510326-export "Title")
  - [5.10.4. Saving Project for the inForm® JHU Processing Farm](vminform/docs/SavingProjectsfortheinFormJHUProcessingFarm.md#5104-saving-projects-for-the-inform-jhu-processing-farm "Title")
    - [5.10.4.1. Description](vminform/docs/SavingProjectsfortheinFormJHUProcessingFarm.md#51041-description "Title")
    - [5.10.4.2. Instructions](vminform/docs/SavingProjectsfortheinFormJHUProcessingFarm.md#51042-instructions "Title")
  - [5.10.5. Adding Slides to the inForm Queue](vminform/docs/AddingSlidestotheinFormQueue.md#5105-adding-slides-to-the-inform-queue)
  - [5.10.6. Evaluating inForm® Phenotype QC Output for the *AstroPath Pipeline*](vminform/docs/EvaluatinginFormPhenotypeQCOutputfortheAstroPathPipeline.md#5106-evaluating-inform-phenotype-qc-output-for-the-astropath-pipeline)
  - [5.10.7. Processing inForm® Tasks](vminform/docs/ProcessinginFormTasks.md#5107-proccessing-inform-tasks)
    - [5.10.7.1. Description](vminform/docs/ProcessinginFormTasks.md#51071-description)
    - [5.10.7.2. Important Definitions](vminform/docs/ProcessinginFormTasks.md#51072-important-definitions)
    - [5.10.7.3. Instructions](vminform/docs/ProcessinginFormTasks.md#51073-instructions)
      - [5.10.7.3.1. Setting up the Virtual Machines for inForm®](vminform/docs/ProcessinginFormTasks.md#510731-setting-up-the-virtual-machines-for-inform)
      - [5.10.7.3.2. Running the ```inform queue``` Module](vminform/docs/ProcessinginFormTasks.md#510732-running-the-inform-queue-module)
      - [5.10.7.3.3. Running the ```inform worker``` Module](vminform/docs/ProcessinginFormTasks.md#510733-running-the-inform-worker-module) 
    - [5.10.7.4. Workflow](vminform/docs/ProcessinginFormTasks.md#51074-workflow) 
...
- [5.13. Validate Data](validatedata#513-validate-data)
  - [5.13.1. Description](validatedata#5131-description)
  - [5.13.2. Instructions](validatedata#5132-instructions)
  - [5.13.3. Next Steps](validatedata#5133-next-steps)
