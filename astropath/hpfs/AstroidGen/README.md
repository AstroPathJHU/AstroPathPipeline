...
1. The  ```ProjectID``` and ```CohortID``` are defined in the *AstropathCohortsProgress.csv* file. 
   - A description of this file is contained [here](https://github.com/AstroPathJHU/AstroPathPipeline/tree/main/scans#34-astropath_processing-directory-and-initializing-projects "Title")
2. The ```BatchID``` is generated for each staining batch 
   - a longer description of this value can be found in the description [here](https://github.com/AstroPathJHU/AstroPathPipeline/tree/main/scans#335-batchids "Title")
3. New ```SampleName```s are detected from the *SpecimenTable.xlsx* files contained in each cohort folder
   ...
   - A description of the *SpecimenTable.xlsx* file is contained [here](https://github.com/AstroPathJHU/AstroPathPipeline/tree/main/scans#331-specimen_table "Title")
...
5. We use path specifiers to shorten descriptions, further description of these paths can be found in the additional documentation [here](https://github.com/AstroPathJHU/AstroPathPipeline/tree/main/scans#322-path-definitions "Title") repository:
