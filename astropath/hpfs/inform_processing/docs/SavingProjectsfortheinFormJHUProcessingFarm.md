...
1.	For example, in the PD1\ PDL1 axis panel we created a segmentation for immune markers and tumor. The markers were PDL1 (520), FoxP3 (540), CD8 (570), Tumor (620), PD1 (650), and CD163 (690). In this panel we select to export the segmentation maps for CD8 (Immune), CD163 (Macrophage), and Tumor. Note that we skip PDL1 since it is designated as an expression marker.
