...
from ...shared.sample import TissueSampleBase, ZoomFolderSampleComponentTiff
...
class CrossRegistrationSample(WSISample, ZoomFolderSampleComponentTiff, AstroPathTissueMaskSample, TissueSampleBase, ThingWithZoomedScale):
  """
