...
from ..baseclasses.sample import DbloadSampleBase, DeepZoomSampleBase, ReadRectanglesComponentTiff, ZoomFolderSampleBase
from ..utilities.dataclasses import MyDataClass
from ..utilities.tableio import pathfield, writetable

class DeepZoomSample(ReadRectanglesComponentTiff, DbloadSampleBase, ZoomFolderSampleBase, DeepZoomSampleBase):
