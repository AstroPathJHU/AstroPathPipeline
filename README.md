...
- [4. Scanning Slides (scans)](astropath/scans#4-scans "Title")
   ...
   - [4.7. AstroIDGen](astropath/hpfs/astroidgen#47-astroid-generation-v0000001 "Title")
   - [4.8. Transfer Daemon](astropath/hpfs/transferdaemon#48-transfer-daemon "Title")
- [5. HPF Processing (hpfs)](astropath/hpfs#5-hpf-processing-hpfs "Title")
  ...
  - [5.5. Meanimages](astropath/hpfs/meanimages#55-meanimages "Title")
  - [5.6. Image Correction](astropath/hpfs/image_correction#56-image-correction "Title")
  - [5.7. Mergeloop](astropath/hpfs/mergeloop#57-mergeloop "Title")
  - [5.8. VMinForm](astropath/hpfs/vminform#58-vminform "Title")
  - [5.9. Segmaps](astropath/hpfs/segmaps#59-seg-maps "Title")
  - [5.10. Create & Transfer Annotations](astropath/hpfs/transferanno#510-transfer-annotations "Title")
  - [5.11. Validate Data](astropath/hpfs/validatedata#511-validate-data)
