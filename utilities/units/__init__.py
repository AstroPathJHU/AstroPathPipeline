...
def setup(mode):
  global correlated_distances, Distance, distances, distances_differentpowers, UnitsError
  ...
  if mode == "safe":
    from .safe.core import correlated_distances, Distance, distances, distances_differentpowers, UnitsError
    from .safe.core import covariance_matrix, microns, nominal_value, nominal_values, pixels, pscale, std_dev, std_devs
  elif mode == "pixels":
    from .fast.pixels.core import correlated_distances, Distance, distances, distances_differentpowers, UnitsError
    from .fast.pixels.core import covariance_matrix, microns, nominal_value, nominal_values, pixels, pscale, std_dev, std_devs
  elif mode == "microns":
    from .fast.microns.core import correlated_distances, Distance, distances, distances_differentpowers, UnitsError
...
__all__ = [
  "correlated_distances", "Distance", "distances", "distances_differentpowers", "UnitsError",
