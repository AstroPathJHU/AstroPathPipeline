...
class TestAlignment(TestBaseCopyInput, TestBaseSaveOutput):
  ...
  def testCohort(self, units="safe"):
    SlideID = "M21_1"
    args = [str(thisfolder/"data"), str(thisfolder/"data"/"flatw"), "--debug", "--dbloadroot", str(thisfolder/"alignment_test_for_jenkins"), "--logroot", str(thisfolder/"alignment_test_for_jenkins"), "--sampleregex", SlideID, "--units", units, "--allow-local-edits", "--ignore-dependencies"]
