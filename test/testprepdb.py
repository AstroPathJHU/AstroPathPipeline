...
class TestPrepDb(unittest.TestCase):
  def testPrepDb(self):
    ...
    for filename, cls, extrakwargs in (
      ("M21_1_annotations.csv", Annotation, {"pscale": sample.pscale}),
      ("M21_1_constants.csv", Constant, {"pscale": sample.pscale}),
      ...
      rows = readtable(thisfolder/"data"/"M21_1"/"dbload"/filename)
